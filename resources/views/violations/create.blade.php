...
@section('content')
    <div class="col-span-12">
        <form action="{{ route(auth()->user()->portalRoutePrefix().'.violations.store') }}" method="POST">
            @csrf
                                    ...
                                    <div class="grid grid-cols-12 gap-6">
                                        <div class="col-span-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="violation" id="violation" class="form-control" value="{{ old('violation') }}" required autofocus />
