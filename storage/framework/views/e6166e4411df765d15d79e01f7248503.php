                                    ...
                                    <?php $__currentLoopData = $ticket->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="#" data-file="<?php echo e($attachment->url); ?>" class="w-9 h-9 rounded-xl inline-flex items-center justify-center btn-link-secondary preview-link">
                                                ...
                                                <div class="flex items-center flex-col">
                                                    ...
                                                    <div class="form-check form-switch p-0 inline w-full mt-4">
                                                        ...
                                                        <input
                                                            ...
                                                            value="Yes"
                                                            id="isNotePublic"
                                                            <?php echo e(!old('is_note_public', $ticket->is_note_public) !== 'No'? 'checked' : ''); ?>
                    ...
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 201) {
                            ...
                            newNoteString += '<h6 class="mb-4">'+data.note+'</h6>'+
                                ...
                                '<span class="absolute right-0 bottom-0-0 bg-success px-2 py-1 text-white rounded"> <span class="ti ti-user"></span> <?php echo e(auth()->user()->name); ?></span>'+
                                '</div>'+
                                '</div>'+
                                '</div>';
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\admin\tickets\edit.blade.php ENDPATH**/ ?>