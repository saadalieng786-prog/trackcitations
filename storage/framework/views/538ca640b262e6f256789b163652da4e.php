...
<head>
    ...
    <title>Page Not Found | <?php echo e(config('app.name', 'Track Citations')); ?></title>
    <link rel="icon" href="<?php echo e(asset('images/favicon.svg')); ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?php echo e(asset('fonts/inter/inter.css')); ?>">
...
<main class="error-shell">
    <section class="error-card" aria-labelledby="error-title">
        <a class="brand" href="<?php echo e($primaryUrl); ?>" aria-label="<?php echo e(config('app.name')); ?>">
            <img src="<?php echo e(asset('images/logo-dark.png')); ?>" alt="<?php echo e(config('app.name')); ?>">
        </a>
        ...
        <div class="actions">
            <a class="button button-primary" href="<?php echo e($primaryUrl); ?>">
                <i class="ti <?php echo e($user ? 'ti-dashboard' : 'ti-home'); ?>" aria-hidden="true"></i>
...
</html><?php /**PATH C:\MAMP\htdocs\trackcitations\resources\views/errors/404.blade.php ENDPATH**/ ?>