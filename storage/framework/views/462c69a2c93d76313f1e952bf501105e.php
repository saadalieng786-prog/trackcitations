        ...
        <?php $__env->startSection('post-scripts'); ?>
            ...
            <script>
                var table = $('.yajra-datatable').DataTable({
                    ...
                    paging: true,
                    ajax: {
                        url: '<?php echo e(route("admin.attorneys.index")); ?>',
                    },
                    columns: [
                        {data: 'id', name: 'id'},
                        {data: 'name', name: 'name'},
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\attorneys\index.blade.php ENDPATH**/ ?>