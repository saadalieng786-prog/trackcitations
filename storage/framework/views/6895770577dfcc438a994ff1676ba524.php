<?php $__env->startSection('content'); ?>
    <div class="col-span-12">
        <form action="<?php echo e(route(auth()->user()->portalRoutePrefix().'.violations.update', $violation->id)); ?>" method="POST">
                                    ...
                                    <div class="grid grid-cols-12 gap-6">
                                        <div class="col-span-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  name="violation" id="violation" class="form-control" value="<?php echo e(old('violation', $violation->violation)); ?>" required autofocus />
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\violations\edit.blade.php ENDPATH**/ ?>