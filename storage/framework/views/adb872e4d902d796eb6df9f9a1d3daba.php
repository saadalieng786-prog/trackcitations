<?php $__env->startSection('content'); ?>
    <div class="col-span-12">
        <form action="<?php echo e(route('driver.tickets.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card">
                                    ...
                                    <div class="grid grid-cols-12 gap-6">
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="col-span-12 md:col-span-3">
                                                ...
                                                <input type="text" class="form-control-plaintext" value="<?php echo e(auth()->user()->name); ?>" readonly="readonly"/>
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control-plaintext" value="<?php echo e(auth()->user()->email); ?>" readonly="readonly"/>
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control-plaintext" value="<?php echo e(auth()->user()->roleable->company?->name); ?>" readonly="readonly"/>
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="city" id="city" value="<?php echo e(old('city', auth()->user()->city)); ?>"/>
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="state" id="state" value="<?php echo e(old('state', auth()->user()->state)); ?>" />
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="zip" id="zip" value="<?php echo e(old('zip', auth()->user()->zip)); ?>" />
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\driver\tickets\create.blade.php ENDPATH**/ ?>