                    ...
                    <div class="flex items-center">
                        ...
                        <div class="grow ltr:ml-3 rtl:mr-3">
                            ...
                            <div class="flex items-center justify-between">
                                <h4 class="mb-0"><?php echo e($stats['tickets']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="grow ltr:ml-3 rtl:mr-3">
                            ...
                            <div class="flex items-center justify-between">
                                <h4 class="mb-0"><?php echo e($stats['drivers']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="grow ltr:ml-3 rtl:mr-3">
                            ...
                            <div class="flex items-center justify-between">
                                <h4 class="mb-0"><?php echo e($stats['companies']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="<?php echo e(route($portal.'.tickets.index')); ?>" class="btn btn-secondary btn-sm">All Open Cases</a>
                </div>
                <ul class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    <?php $__empty_1 = true; $__currentLoopData = ($pendingTickets ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendingTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item">
                            <div class="flex items-center justify-between gap-3">
                                <div class="grow">
                                    <h6 class="mb-1"><?php echo e($pendingTicket->name); ?></h6>
                                    <p class="mb-0 text-muted">
                                        Company: <?php echo e(optional($pendingTicket->company)->name ?: 'N/A'); ?> |
                                        Attorney: <?php echo e(optional(optional($pendingTicket->attorney)->user)->name ?: 'Unassigned'); ?>

                                    </p>
                                    <p class="mb-0 mt-1 text-muted">
                                        Indicator: <?php echo e($pendingTicket->indicator ?: 'Pending'); ?> |
                                        Points Saved: <?php echo e(number_format($pendingTicket->points_saved, 1)); ?>

                                    </p>
                                </div>
                                <a href="<?php echo e(route($portal.'.tickets.edit', $pendingTicket->id)); ?>" class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-light-secondary">
    ...
    <div class="col-span-12 lg:col-span-5">
        <div class="card">
            <div class="card-body">
                ...
                <?php $__empty_1 = true; $__currentLoopData = ($upComingCourtDates ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upComingCourtDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
    ...
    <div class="col-span-12 lg:col-span-5">
        <div class="card">
            <div class="card-body">
                ...
                <ul class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    <?php $__empty_1 = true; $__currentLoopData = ($recentClosedTickets ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item">
                            <div class="flex items-center justify-between gap-3">
                                <div class="grow">
    ...
    <div class="col-span-12 lg:col-span-7">
        <div class="card">
            <div class="card-body">
                ...
                <ul class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    <?php $__empty_1 = true; $__currentLoopData = ($companySnapshots ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item">
                            <div class="flex items-center justify-between gap-3">
                                <div class="grow">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\trackcitations\resources\views\manager\dashboard.blade.php ENDPATH**/ ?>