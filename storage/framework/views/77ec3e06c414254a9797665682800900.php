            ...
            <div class="card-body !py-0">
                <ul class="flex flex-wrap w-full font-medium text-center nav-tabs items-center">
                    ...
                    <li class="group ml-auto">
                        <a
                            href="<?php echo e(route(auth()->user()->portalRoutePrefix().'.tickets.edit', $ticket->id)); ?>"
                            data-pc-toggle="tab"
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\admin\tickets\show.blade.php ENDPATH**/ ?>