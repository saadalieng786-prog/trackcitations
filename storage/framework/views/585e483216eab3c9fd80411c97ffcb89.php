        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1 mb-0">
                    Welcome back, <span class="font-semibold text-slate-700"><?php echo e($userName); ?></span>! Here's what's happening today.
                </p>
            </div>
            <div>
                <button type="button" class="tc-date-filter-btn">
                    <i class="ti ti-calendar text-slate-400 text-sm"></i>
                    <span><?php echo e(now()->format('M j, Y')); ?></span>
        ...
        <div class="col-span-12 lg:col-span-3 md:col-span-6">
            <div class="tc-stat-card-v2">
                ...
                <div class="mt-3">
                    ...
                    <div class="tc-stat-value-v2"><?php echo e(number_format($s['attorneys'] ?: 1542)); ?></div>
                    <div class="tc-stat-trend up">
                        <i class="ti ti-arrow-up-right"></i>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>