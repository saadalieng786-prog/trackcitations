            ...
            <div class="card">
                <div class="card-header">
                    <div class="sm:flex items-center justify-between">
                        ...
                        <div>
                            <a href="<?php echo e(route(auth()->user()->portalRoutePrefix().'.violations.create')); ?>" class="btn btn-primary">Create Citation</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <?php $__env->startSection('post-scripts'); ?>
            ...
            <script>
                var table = $('.yajra-datatable').DataTable({
                    ...
                    paging: true,
                    ajax: {
                        url: '<?php echo e(route(auth()->user()->portalRoutePrefix().".violations.index")); ?>',
                    },
                    columns: [
                        {data: 'id', name: 'id'},
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\violations\index.blade.php ENDPATH**/ ?>