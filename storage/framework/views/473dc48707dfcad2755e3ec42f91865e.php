<?php $__env->startSection('content'); ?>
    <div class="col-span-12">
        <form action="<?php echo e(route(auth()->user()->portalRoutePrefix().'.attorneys.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card">
                                    ...
                                    <div class="grid grid-cols-12 gap-6 items-center">
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="office_hours_start" id="officeHoursStart" class="form-control" value="<?php echo e(old('office_hours_start')); ?>" />
                                        ...
                                        <div class="col-span-12 sm:col-span-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="office_hours_end" id="officeHoursEnd" class="form-control" value="<?php echo e(old('office_hours_end')); ?>" />
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\attorneys\create.blade.php ENDPATH**/ ?>