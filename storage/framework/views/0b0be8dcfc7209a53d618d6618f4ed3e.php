            ...
            <div class="card">
                <div class="card-header">
                    <div class="sm:flex items-center justify-between">
                        ...
                        <div>
                            <a href="<?php echo e(route(Auth::user()->portalRoutePrefix().'.managers.create')); ?>" class="btn btn-primary">Create Company Admin</a>
                        </div>
                        <?php endif; ?>
        ...
        <?php $__env->startSection('post-scripts'); ?>
            ...
            <script>
                var table = $('.yajra-datatable').DataTable({
                    ...
                    paging: true,
                    ajax: {
                        url: '<?php echo e(route(auth()->user()->portalRoutePrefix().".managers.index")); ?>',
                    },
                    columns: [
                        {data: 'id', name: 'id'},
                        {data: 'name', name: 'name'},
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP\trackcitations\resources\views\managers\index.blade.php ENDPATH**/ ?>